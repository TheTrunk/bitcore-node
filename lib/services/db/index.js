...
function DB(options) {
  ...
  this.GENESIS_HASH = constants.HUSH_GENESIS_HASH[this.node.network];
...
DB.prototype._setDataPath = function() {
  ...
  if (this.node.network === 'livenet' || this.node.network === 'mainnet') {
    this.dataPath = this.node.datadir + '/bitcorenodehush.db';
  } else if (this.node.network === 'regtest') {
      this.dataPath = this.node.datadir + '/regtest/bitcorenodehush.db';
  } else if (this.node.network === 'testnet') {
      this.dataPath = this.node.datadir + '/testnet/bitcorenodehush.db';
  } else {
