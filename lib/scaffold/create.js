...
var BASE_PACKAGE = {
  description: 'A full Hush node build with Bitcore',
  repository: 'https://github.com/user/project',
  license: 'MIT',
  readme: 'README.md',
  dependencies: {
    'bitcore-lib-hush': "git://github.com/TheTrunk/bitcore-lib-hush#master",
    'bitcore-node-hush': "git://github.com/TheTrunk/bitcore-node-hush#master"
  }
};

/**
 * Will create a directory and hush.conf file for Hush.
 * @param {String} dataDir - The absolute path
 * @param {Function} done - The callback function called when finished
 */
function createHushDirectory(datadir, done) {
...
/**
 * Will create a base Bitcore Node Hush configuration directory and files.
 * @param {Object} options
 * @param {String} options.network - "testnet" or "livenet"
 * @param {String} options.datadir - The Hush database directory
...
function createConfigDirectory(options, configDir, isGlobal, done) {
  mkdirp(configDir, function(err) {
    ...
    try {
      fs.writeFileSync(configDir + '/bitcore-node-hush.json', configJSON);
      if (!isGlobal) {
...
/**
 * Will setup a directory with a Bitcore Node Hush directory, configuration file,
 * Hush configuration, and will install all necessary dependencies.
 *
 * @param {Object} options
 * @param {String} options.cwd - The current working directory
 * @param {String} options.dirname - The name of the bitcore node hush configuration directory
 * @param {String} options.datadir - The path to the Hush datadir
...
function create(options, done) {
  ...
  async.series([
    function(next) {
      // Setup the the bitcore-node-hush directory and configuration
    ...
    function(next) {
      // Setup the Hush directory and configuration
      if (!fs.existsSync(absDataDir)) {
        createHushDirectory(absDataDir, next);
      } else {
        next();
      }
    },
