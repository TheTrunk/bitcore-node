...
function main(servicesPath, additionalServices) {
  ...
  program
    ...
    .option('-d, --datadir <dir>', 'Specify the Hush database directory')
  ...
  program
    ...
    .option('-c, --config <dir>', 'Specify the directory with Bitcore Node Hush configuration')
    .action(function(cmd){
      if (cmd.config) {
  ...
  program
    ...
    .action(function(services){
      ...
      if (!configInfo) {
        throw new Error('Could not find configuration, see `bitcore-node-hush create --help`');
      }
      var opts = {
      ...
      console.log();
      console.log('    $ bitcore-node-hush add bitcore-wallet-service-hush');
      console.log('    $ bitcore-node-hush add insight-api-hush');
      console.log();
    });
  ...
  program
    ...
    .action(function(services){
      ...
      console.log('  Examples:');
      console.log();
      console.log('    $ bitcore-node-hush remove bicore-wallet-service-hush');
      console.log('    $ bitcore-node-hush remove insight-api-hush');
      console.log();
    });
